...
public class MyProject {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("\n");
        if (feeling == 1) {
        	//Analyze the age for the correct response for a very sad attitude
        	...
        	//Analyze the age for the correct response for a sad attitude
        	...
        	//Analyze the age for the correct response for a neutral attitude
        	...
        	//Analyze the age for the correct response for a happy attitude
        	...
        	//Analyze the age for the correct response for a very happy attitude
